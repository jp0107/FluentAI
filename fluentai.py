...
def prof_dashboard(course_id):
    ...
    if user_type == "Student":
        ...
        return flask.redirect('student-classes')  # Redirecting to the home page or a suitable route
...
def admin_dashboard():
    ...
    if(user_type == "Professor"):
        flask.flash("Access denied: Unauthorized access.", "error")
        return flask.redirect('prof-classes')  # Redirecting to the home page or a suitable route
